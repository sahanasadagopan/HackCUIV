...
public class LeapToServo implements Runnable{
    public static final String CHANNEL = "echo-server";
    ...
    public LeapToServo(String pubKey, String subKey){
        ...
        try {
            ...
            pubnub.subscribe("echo-server", new Callback() {
                        @Override
    ...
    public static void main(String[] args) {
        String pubKey = "pub-c-0dee2dd3-f22e-4d01-b741-ebe89f355b68";
        String subKey = "sub-c-3f7513e0-19a9-11e8-95aa-1eb18890f15d";
